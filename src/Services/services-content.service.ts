import { ServicesVideo, ServicesImage } from './../assets/assets';
import { Injectable } from '@angular/core';
import { IservicePageContent } from '../Models/iservics';

@Injectable({
  providedIn: 'root'
})
export class ServicesContentService {
  ServicePageContent: IservicePageContent;
  constructor() {
    this.ServicePageContent = {
      dismantle: {
  ...
  getAllServices(): IservicePageContent {
    return this.ServicePageContent;
  }


  getService(serviceId: keyof IservicePageContent) {
    return this.ServicePageContent[serviceId];
  }
}
